# PC-Spezialist Gü UI - Based on: WinConfigHelper v4 - UI Script
...
$scripts = @(
    ...
    [pscustomobject]@{ Name = 'UWScript v2.1'; File = 'UWScript.ps1' },
    # Debloaters
    ...
    [pscustomobject]@{ Name = 'Remove OneDrive'; File = 'Cleanup/OneDriveRemover/_OneDriveRemover.bat' },
    # Privacy Internet Blockers

    # Fixes & Misc.
    [pscustomobject]@{ Name = 'Visual Effects'; File = 'fixes/VisualEffects.bat' },
    [pscustomobject]@{ Name = 'Program Installer'; File = 'misc/Program_Installer.bat' },
    [pscustomobject]@{ Name = 'Default Programs'; File = 'misc/default_apps.bat' },
    [pscustomobject]@{ Name = 'Bitlocker Fix'; File = 'misc/DisableBitlocker.ps1' },
    [pscustomobject]@{ Name = 'Snap Assist [FIX]'; File = 'fixes/SnapAssist.bat' },
    [pscustomobject]@{ Name = 'Enable Gamebar [FIX]'; File = 'fixes/EnableGamebar.bat' },
    [pscustomobject]@{ Name = 'Time Change [FIX]'; File = 'fixes/time_changer.bat' },
    # Cleaners
    [pscustomobject]@{ Name = 'Tron Cleaner'; File = 'Cleanup/stage_1_tempclean/stage_1_tempclean.bat' },
    [pscustomobject]@{ Name = 'Privacy.sexy Cleanup'; File = 'Cleanup/Cleanup_privacy.sexy.bat' }
)
...
function Show-SelectionMenu {
    ...
    $selectedNames = Write-Menu -Title "  PC-Spezialist Gue v3b`n    Tab = Confirm`n    A=all | U=none" -Entries $scriptNames -MultiSelect
