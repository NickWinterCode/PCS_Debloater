...
Write-Host "Disabling Recommended Section in Startmenu..."
...
Write-Host "Disabling New Outlook..."
...
Set-ItemProperty -Path "HKCU:\Software\Policies\Microsoft\Office\16.0\Outlook\Options\General" -Name "DoNewOutlookAutoMigration" -Value 0 -Type DWord
Remove-ItemProperty -Path "HKCU:\Software\Policies\Microsoft\Office\16.0\Outlook\Preferences" -Name "NewOutlookMigrationUserSetting" -ErrorAction SilentlyContinue
...
Write-Host "Disabling S3 Sleep..."
Remove-ItemProperty -Path "HKLM:\SYSTEM\CurrentControlSet\Control\Power" -Name "PlatformAoAcOverride" -ErrorAction SilentlyContinue
...
Write-Host "Enabling Verbose Messages During Logon..."
...
Write-Host "Disabling Cross-Device Resume..."
Set-ItemProperty -Path "HKCU:\Software\Microsoft\Windows\CurrentVersion\CrossDeviceResume\Configuration" -Name "IsResumeAllowed" -Value 0 -Type DWord
...
Write-Host "Removing Settings Home Page..."
Set-ItemProperty -Path "HKCU:\Software\Microsoft\Windows\CurrentVersion\Policies\Explorer" -Name "SettingsPageVisibility" -Value "hide:home" -Type String
