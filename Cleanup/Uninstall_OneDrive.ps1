Write-Host "----- Close OneDrive Process" -ForegroundColor Cyan
...
Set-ItemProperty -Path "HKEY_CLASSES_ROOT\CLSID\{018D5C66-4533-4307-9B53-224DE2ED1FE6}" -Name "System.IsPinnedToNameSpaceTree" -Value 0
Set-ItemProperty -Path "HKEY_CLASSES_ROOT\Wow6432Node\CLSID\{018D5C66-4533-4307-9B53-224DE2ED1FE6}" -Name "System.IsPinnedToNameSpaceTree" -Value 0
...
if (Test-Path $oneDriveSetup64) {
    Write-Host "Running uninstaller from SysWOW64..." -ForegroundColor Yellow
    Start-Process -FilePath $oneDriveSetup64 -ArgumentList "/uninstall" -NoNewWindow -Wait
}

if (Test-Path $oneDriveSetup32) {
    Write-Host "Running uninstaller from System32..." -ForegroundColor Yellow
    Start-Process -FilePath $oneDriveSetup32 -ArgumentList "/uninstall" -NoNewWindow -Wait
}

Write-Host "----- Remove OneDrive leftovers" -ForegroundColor Cyan
...
# Set registry policies to disable OneDrive
Write-Host "Setting registry policies..." -ForegroundColor Yellow
...
New-Item -Path "HKLM:\SOFTWARE\Microsoft\OneDrive" -Force -ErrorAction SilentlyContinue | Out-Null
...
# Remove OneDrive from Explorer sidebar (HKCR requires special handling)
REG DELETE "HKEY_CLASSES_ROOT\CLSID\{018D5C66-4533-4307-9B53-224DE2ED1FE6}" /f
REG DELETE "HKEY_CLASSES_ROOT\Wow6432Node\CLSID\{018D5C66-4533-4307-9B53-224DE2ED1FE6}" /f

# Remove OneDriveSetup from Run key
Write-Host "Removing OneDriveSetup from startup..." -ForegroundColor Yellow
