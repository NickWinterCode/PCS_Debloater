...
# 3. Permanently disable the BitLocker service (prevents it from ever starting again)
Write-Host "`nStep 3: Killing and disabling BitLocker service (BDESVC)..." -ForegroundColor Cyan
...
# 4. Block Windows from ever turning on Device Encryption / BitLocker again (works on Home too)
Write-Host "`nStep 4: Applying registry locks to prevent re-enabling..." -ForegroundColor Cyan
