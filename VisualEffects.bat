...
echo Backing up current settings (REG exports to script folder)...
::reg export "HKCU\Control Panel\Desktop" "%~dp0backup-Desktop.reg" /y >nul 2>&1
::reg export "HKCU\Software\Microsoft\Windows\CurrentVersion\Explorer\Advanced" "%~dp0backup-ExplorerAdvanced.reg" /y >nul 2>&1
::reg export "HKCU\Software\Microsoft\Windows\CurrentVersion\Explorer\VisualEffects" "%~dp0backup-VisualEffects.reg" /y >nul 2>&1
::reg export "HKCU\Software\Microsoft\Windows\DWM" "%~dp0backup-DWM.reg" /y >nul 2>&1
